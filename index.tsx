...
const LogoIcon = ({ size = 32 }: { size?: number }) => (
    <svg width={size} height={size} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="app-logo">
        <rect width="100" height="100" rx="12" className="logo-bg"/>
        <path d="M30 75V25H70V35H50V75H30Z" className="logo-mark"/>
    </svg>
);
